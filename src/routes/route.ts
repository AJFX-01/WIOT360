...
export default async function vehicleRoutes(fastify: FastifyInstance) {
  ...
  fastify.put('/vehicle-types/:id', controller.updateVehicleType);
  fastify.put('/operations/:id', controller.updateOperation);
  fastify.put('/schedules/:id', controller.updateSchedule);
